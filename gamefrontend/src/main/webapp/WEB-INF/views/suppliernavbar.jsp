<div class="jumbotron">
  <div class="container text-center">
	<img src="./resources/image/LOGO.png" class="img-rounded" alt="NIIT" width="200" height="120">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="./resources/image/Capture.jpg" class="img-rounded" alt="NIIT" width="40" height="30"> </a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="orders"><span class="glyphicon glyphicon-tasks"></span>My Orders<span class="badge"></span> </a></li>
